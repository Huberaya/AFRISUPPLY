...
## Photos produits
`apps/web/public/produits/<slug>.jpg` (slug = nom normalisé, cf. `docs/_products_slugs.json`). Générées par IA en lot (640 px, ~50 Ko) ; à défaut, icône de rayon. Génération par lots de 10 (limite outil) ; 239/324 au 21/09/2026.
