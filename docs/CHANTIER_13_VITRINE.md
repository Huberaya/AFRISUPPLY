...
## Photos produits
`apps/web/public/produits/<slug>.jpg` (slug = nom normalisé, cf. `docs/_products_slugs.json`). Générées par IA en lot (640 px, ~50 Ko) ; à défaut, icône de rayon. Génération par lots de 10 (limite outil) ; 259/324 au 22/09/2026 — à partir du lot 17, contenants variés (bocal, planche, panier, sac kraft, ardoise…) pour éviter la monotonie, même lumière et lin beige.
