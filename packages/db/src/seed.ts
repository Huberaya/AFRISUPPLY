...
type Cat = (typeof s.productCategory.enumValues)[number];
type Unit = (typeof s.unit.enumValues)[number];

const P = (name: string, category: Cat, baseUnit: Unit, origin?: string, aliases: string[] = [], shelfLifeDays?: number) =>
  ({ name, category, baseUnit, origin, aliases, shelfLifeDays });

export const REFERENCE_PRODUCTS = [
  // 🌾 Féculents
  P('Riz parfumé', 'feculents', 'kg', 'Thaïlande', ['riz jasmin', 'riz thaï'], 365),
  P('Riz brisé', 'feculents', 'kg', 'Sénégal', ['riz cassé', 'riz thiéb'], 365),
  P('Attiéké', 'feculents', 'kg', "Côte d'Ivoire", ['attieke', 'garba', 'semoule de manioc'], 10),
  P('Manioc frais', 'feculents', 'kg', 'Cameroun', ['cassava'], 7),
  P('Plantain', 'feculents', 'kg', 'Côte d\'Ivoire', ['banane plantain', 'alloco'], 7),
  P('Igname', 'feculents', 'kg', 'Ghana', ['yam'], 21),
  P('Patate douce', 'feculents', 'kg', 'Sénégal', [], 21),
  P('Gari', 'feculents', 'kg', 'Bénin', ['farine de manioc'], 365),
  P('Farine de foufou', 'feculents', 'kg', 'Cameroun', ['fufu'], 365),
  // 🥬 Frais
  P('Tomate', 'frais', 'kg', 'France', [], 7),
  P('Oignon', 'frais', 'kg', 'France', ['oignon jaune'], 30),
  P('Piment frais', 'frais', 'kg', 'Espagne', ['piment antillais', 'habanero'], 10),
  P('Gombo', 'frais', 'kg', 'Sénégal', ['okra'], 5),
  P('Aubergine africaine', 'frais', 'kg', "Côte d'Ivoire", ['djakatou', 'garden egg'], 7),
  P('Feuilles de manioc', 'frais', 'kg', 'Cameroun', ['saka-saka', 'pondu'], 3),
  P('Ndolé', 'frais', 'kg', 'Cameroun', ['feuilles de ndolé'], 3),
  P('Gingembre frais', 'frais', 'kg', 'Nigeria', [], 21),
  P('Citron vert', 'frais', 'kg', 'Brésil', ['lime'], 14),
  P('Persil', 'frais', 'botte', 'France', [], 5),
  P('Chou', 'frais', 'kg', 'France', ['chou blanc'], 14),
  P('Carotte', 'frais', 'kg', 'France', [], 21),
  // 🥩 Viandes & poissons
  P('Poulet entier', 'viandes_poissons', 'kg', 'France', ['poulet'], 4),
  P('Cuisses de poulet', 'viandes_poissons', 'kg', 'France', [], 4),
  P('Bœuf à braiser', 'viandes_poissons', 'kg', 'France', ['boeuf', 'viande de bœuf'], 4),
  P('Mouton', 'viandes_poissons', 'kg', 'France', ['agneau'], 4),
  P('Capitaine', 'viandes_poissons', 'kg', 'Sénégal', ['thiof'], 2),
  P('Tilapia', 'viandes_poissons', 'kg', 'Chine', ['carpe'], 2),
  P('Poisson fumé', 'viandes_poissons', 'kg', 'Sénégal', ['guedj', 'kong'], 30),
  P('Crevettes séchées', 'viandes_poissons', 'kg', 'Nigeria', ['crayfish'], 180),
  // 🫙 Épicerie
  P('Huile de palme', 'epicerie', 'L', "Côte d'Ivoire", ['huile rouge', 'zomi'], 365),
  P('Huile de tournesol', 'epicerie', 'L', 'France', ['huile végétale'], 365),
  P('Pâte d\'arachide', 'epicerie', 'kg', 'Sénégal', ['beurre de cacahuète', 'tigadèguè'], 180),
  P('Concentré de tomate', 'epicerie', 'kg', 'Italie', ['double concentré'], 365),
  P('Cube bouillon', 'epicerie', 'piece', 'France', ['maggi', 'jumbo'], 365),
  P('Soumbala', 'epicerie', 'kg', 'Burkina Faso', ['nététou', 'dawadawa'], 180),
  P('Poivre de Guinée', 'epicerie', 'kg', 'Guinée', ['maniguette'], 365),
  P('Ail', 'epicerie', 'kg', 'Espagne', [], 60),
  P('Moutarde', 'epicerie', 'kg', 'France', [], 365),
  P('Vinaigre', 'epicerie', 'L', 'France', [], 730),
  P('Sel', 'epicerie', 'kg', 'France', [], 1000),
  P('Sucre', 'epicerie', 'kg', 'France', [], 1000),
  P('Tamarin (pulpe)', 'epicerie', 'kg', 'Mali', ['dakhar'], 180),
  // 🥤 Boissons
  P('Fleurs de bissap', 'boissons', 'kg', 'Sénégal', ['hibiscus', 'oseille de Guinée'], 365),
  P('Poudre de baobab', 'boissons', 'kg', 'Sénégal', ['bouye', 'pain de singe'], 365),
  P('Gingembre séché', 'boissons', 'kg', 'Nigeria', [], 365),
  P('Menthe fraîche', 'boissons', 'botte', 'Maroc', [], 5),
  P('Eau minérale 50 cl', 'boissons', 'piece', 'France', [], 730),
  P('Bière Flag 33 cl', 'boissons', 'piece', 'Sénégal', [], 365),
  // 📦 Emballages
  P('Barquette alu 1000 mL', 'emballages', 'piece', 'France', ['barquette aluminium'], 3650),
  P('Sac kraft', 'emballages', 'piece', 'France', [], 3650),
  P('Gobelet 33 cl', 'emballages', 'piece', 'France', [], 3650),
] as const;
...
export async function seedDemo(opts: { force?: boolean } = {}) {
  ...
  if (missing.length) {
    const inserted = await db.insert(s.products).values(
      missing.map((p) => ({ name: p.name, category: p.category, baseUnit: p.baseUnit, origin: p.origin, aliases: [...p.aliases], shelfLifeDays: p.shelfLifeDays })),
  ...
  const offers: O[] = [
    ...
    [PRIM, 'Tomate', 'Plateau 6 kg', 6, 9.60], [PRIM, 'Oignon', 'Sac 10 kg', 10, 8.90], [PRIM, 'Piment frais', 'Barquette 1 kg', 1, 7.80],
    [PRIM, 'Gombo', 'Carton 4 kg', 4, 18.00], [PRIM, 'Feuilles de manioc', 'Sachet 1 kg', 1, 6.50], [PRIM, 'Ndolé', 'Sachet 1 kg', 1, 7.90], [PRIM, 'Manioc frais', 'Carton 10 kg', 10, 16.00], [PRIM, 'Patate douce', 'Carton 10 kg', 10, 14.00], [TROPIC, 'Crevettes séchées', 'Sachet 500 g', 0.5, 9.50], [PRIM, 'Aubergine africaine', 'Carton 5 kg', 5, 16.50], [PRIM, 'Gingembre frais', 'Carton 5 kg', 5, 17.50],
    [PRIM, 'Citron vert', 'Carton 4 kg', 4, 9.20], [PRIM, 'Persil', 'Botte', 1, 0.90], [PRIM, 'Chou', 'Pièce 2 kg', 2, 2.40], [PRIM, 'Carotte', 'Sac 10 kg', 10, 7.50],
    [VOL, 'Poulet entier', 'Carton 10 kg', 10, 48.00], [TROPIC, 'Poulet entier', 'Carton 10 kg', 10, 44.00],
    [VOL, 'Cuisses de poulet', 'Carton 10 kg', 10, 42.00], [VOL, 'Bœuf à braiser', 'Colis 5 kg', 5, 54.50], [VOL, 'Mouton', 'Colis 5 kg', 5, 62.00],
    [TROPIC, 'Capitaine', 'Carton 10 kg', 10, 129.00], [TROPIC, 'Tilapia', 'Carton 10 kg', 10, 58.00], [TROPIC, 'Poisson fumé', 'Carton 5 kg', 5, 72.00], [AFRO, 'Poisson fumé', 'Carton 5 kg', 5, 75.00],
    [AFRO, 'Huile de palme', 'Bidon 5 L', 5, 24.50], [TROPIC, 'Huile de palme', 'Bidon 5 L', 5, 22.00], [SAHEL, 'Huile de palme', 'Bidon 5 L', 5, 21.50],
    ...
    [AFRO, 'Concentré de tomate', 'Boîte 4,5 kg', 4.5, 9.80], [AFRO, 'Cube bouillon', 'Carton 240 cubes', 240, 19.00], [SAHEL, 'Soumbala', 'Sachet 1 kg', 1, 14.00],
    [AFRO, 'Ail', 'Filet 5 kg', 5, 17.00], [AFRO, 'Moutarde', 'Seau 5 kg', 5, 12.50], [AFRO, 'Vinaigre', 'Bidon 5 L', 5, 6.50], [AFRO, 'Sel', 'Sac 25 kg', 25, 9.00], [AFRO, 'Sucre', 'Sac 25 kg', 25, 26.00],
    [SAHEL, 'Tamarin (pulpe)', 'Bloc 1 kg', 1, 6.80], [AFRO, 'Tamarin (pulpe)', 'Bloc 1 kg', 1, 7.20],
    [AFRO, 'Fleurs de bissap', 'Sac 5 kg', 5, 39.00], [SAHEL, 'Fleurs de bissap', 'Sac 5 kg', 5, 34.50], [TROPIC, 'Fleurs de bissap', 'Sac 5 kg', 5, 37.00],
    [SAHEL, 'Poudre de baobab', 'Sac 1 kg', 1, 11.00], [SAHEL, 'Gingembre séché', 'Sac 1 kg', 1, 8.50], [PRIM, 'Menthe fraîche', 'Botte', 1, 0.80],
    [AFRO, 'Eau minérale 50 cl', 'Pack 24', 24, 7.20], [AFRO, 'Bière Flag 33 cl', 'Carton 24', 24, 31.00],
    [AFRO, 'Barquette alu 1000 mL', 'Carton 500', 500, 62.00], [AFRO, 'Sac kraft', 'Carton 500', 500, 38.00], [AFRO, 'Gobelet 33 cl', 'Carton 1000', 1000, 45.00],
  ];
  ...
  for (const o of offerRows) {
    ...
    const prod = REFERENCE_PRODUCTS.find((p) => pid(p.name) === o.productId)!;
    const hike = (o.supplierId === AFRO && prod.name === 'Huile de palme') ? 0.12 : (o.supplierId === VOL && prod.name === 'Poulet entier') ? 0.09 : 0;
  ...
  const RECIPES: { name: string; price: number; ing: [string, number][] }[] = [
    { name: 'Poulet braisé', price: 18, ing: [['Poulet entier', 0.45], ['Riz parfumé', 0.12], ['Oignon', 0.08], ['Huile de tournesol', 0.03], ['Piment frais', 0.01], ['Moutarde', 0.015], ['Cube bouillon', 1], ['Plantain', 0.15]] },
    { name: 'Mafé bœuf', price: 16, ing: [['Bœuf à braiser', 0.2], ["Pâte d'arachide", 0.08], ['Riz parfumé', 0.15], ['Tomate', 0.08], ['Concentré de tomate', 0.02], ['Oignon', 0.06], ['Patate douce', 0.08], ['Carotte', 0.05], ['Huile de tournesol', 0.02], ['Cube bouillon', 1]] },
    { name: 'Yassa poulet', price: 16, ing: [['Cuisses de poulet', 0.35], ['Oignon', 0.25], ['Citron vert', 0.06], ['Moutarde', 0.02], ['Riz parfumé', 0.15], ['Huile de tournesol', 0.03], ['Cube bouillon', 1]] },
    { name: 'Thiéboudienne', price: 17, ing: [['Capitaine', 0.25], ['Riz brisé', 0.18], ['Tomate', 0.08], ['Concentré de tomate', 0.03], ['Chou', 0.08], ['Carotte', 0.06], ['Manioc frais', 0.06], ['Aubergine africaine', 0.05], ['Huile de tournesol', 0.04], ['Poisson fumé', 0.02], ['Cube bouillon', 1]] },
    { name: 'Attiéké poisson', price: 15, ing: [['Attiéké', 0.25], ['Tilapia', 0.35], ['Tomate', 0.08], ['Oignon', 0.06], ['Piment frais', 0.01], ['Huile de tournesol', 0.04], ['Citron vert', 0.03]] },
    { name: 'Alloco', price: 6, ing: [['Plantain', 0.3], ['Huile de tournesol', 0.06], ['Piment frais', 0.005], ['Oignon', 0.03]] },
    { name: 'Ndolé crevettes', price: 17, ing: [['Ndolé', 0.15], ["Pâte d'arachide", 0.06], ['Crevettes séchées', 0.03], ['Bœuf à braiser', 0.12], ['Oignon', 0.05], ['Huile de palme', 0.03], ['Plantain', 0.15], ['Ail', 0.005]] },
    { name: 'Saka-saka', price: 14, ing: [['Feuilles de manioc', 0.2], ['Huile de palme', 0.04], ['Poisson fumé', 0.05], ['Oignon', 0.04], ['Riz parfumé', 0.15], ['Cube bouillon', 1]] },
    { name: 'Jus de bissap 33 cl', price: 3.5, ing: [['Fleurs de bissap', 0.02], ['Sucre', 0.04], ['Menthe fraîche', 0.05], ['Gobelet 33 cl', 1]] },
    { name: 'Jus de gingembre 33 cl', price: 3.5, ing: [['Gingembre frais', 0.06], ['Sucre', 0.04], ['Citron vert', 0.02], ['Gobelet 33 cl', 1]] },
  ];
  ...
  const INV: Inv[] = [
    ...
    ['Tomate', 11, 8, 20, PRIM], ['Oignon', 26, 12, 40, PRIM], ['Piment frais', 1.5, 1, 3, PRIM], ['Gombo', 3, 2, 6, PRIM], ['Aubergine africaine', 2, 2, 6, PRIM],
    ['Feuilles de manioc', 1.2, 1.5, 4, PRIM], ['Ndolé', 2.5, 1.5, 4, PRIM], ['Gingembre frais', 6, 4, 10, PRIM], ['Citron vert', 5, 3, 8, PRIM], ['Chou', 6, 4, 10, PRIM], ['Carotte', 7, 4, 12, PRIM], ['Menthe fraîche', 6, 5, 15, PRIM],
    ['Poulet entier', 34, 25, 70, VOL], ['Cuisses de poulet', 18, 15, 40, VOL], ['Bœuf à braiser', 9, 6, 15, VOL], ['Capitaine', 7, 6, 15, TROPIC], ['Tilapia', 12, 8, 20, TROPIC], ['Poisson fumé', 3, 2, 6, AFRO], ['Crevettes séchées', 1, 0.5, 2, TROPIC],
    ['Huile de palme', 4, 5, 15, AFRO], ['Huile de tournesol', 22, 10, 30, AFRO], ["Pâte d'arachide", 6, 4, 10, AFRO], ['Concentré de tomate', 5, 3, 9, AFRO], ['Cube bouillon', 180, 100, 480, AFRO],
    ['Ail', 2, 1, 5, AFRO], ['Moutarde', 3, 2, 5, AFRO], ['Sucre', 18, 10, 30, AFRO], ['Sel', 12, 5, 25, AFRO],
    ['Fleurs de bissap', 2.5, 3, 10, AFRO], ['Gobelet 33 cl', 600, 400, 2000, AFRO], ['Barquette alu 1000 mL', 250, 200, 1000, AFRO],
  ];
  ...
  const pastOrders: { sup: string; d: number; lines: [string, number][]; late?: boolean; short?: [string, number] }[] = [
    { sup: AFRO, d: 42, lines: [['Riz parfumé', 2], ['Huile de palme', 2], ['Cube bouillon', 1]] },
    { sup: VOL, d: 40, lines: [['Poulet entier', 4], ['Bœuf à braiser', 2]] },
    { sup: PRIM, d: 38, lines: [['Tomate', 3], ['Oignon', 2], ['Plantain', 1]] },
    { sup: AFRO, d: 28, lines: [['Attiéké', 2], ['Riz parfumé', 2], ['Fleurs de bissap', 1]], late: true },
    { sup: VOL, d: 26, lines: [['Poulet entier', 5], ['Cuisses de poulet', 2]] },
    { sup: TROPIC, d: 21, lines: [['Capitaine', 1], ['Tilapia', 2], ['Riz brisé', 2]], short: ['Riz brisé', 45] },
    { sup: PRIM, d: 17, lines: [['Tomate', 3], ['Oignon', 2], ['Gombo', 1], ['Piment frais', 2]] },
    { sup: AFRO, d: 14, lines: [['Riz parfumé', 2], ['Huile de palme', 2], ['Sucre', 1]] },
    { sup: VOL, d: 12, lines: [['Poulet entier', 5]] },
    { sup: PRIM, d: 9, lines: [['Tomate', 2], ['Oignon', 2], ['Feuilles de manioc', 2], ['Menthe fraîche', 20]] },
    { sup: AFRO, d: 5, lines: [['Attiéké', 2], ['Plantain', 1]], late: true },
    { sup: VOL, d: 3, lines: [['Poulet entier', 4], ['Bœuf à braiser', 1]] },
  ];
  let seq = 100;
  ...
  await db.insert(s.reorderRules).values([
    ...
    { restaurantId: rid, inventoryItemId: invByProduct.get(pid('Poulet entier'))!, threshold: '25', reorderQty: '50', supplierStrategy: 'preferred' },
    { restaurantId: rid, inventoryItemId: invByProduct.get(pid('Huile de palme'))!, threshold: '5', reorderQty: '15', supplierStrategy: 'best' },
  ]);
