...
import { Store, Package, Inbox, Users, Receipt, Check, X, Truck, LogOut, BarChart3, FileText, Scale } from 'lucide-react';
...
type Tab = 'dashboard' | 'offers' | 'orders' | 'fulfillment' | 'claims' | 'groupbuys' | 'commissions' | 'analytics';
