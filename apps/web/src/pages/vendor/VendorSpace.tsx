...
type VOrder = { id: string; reference: string; status: string; totalEur: string; expectedAt: string | null; createdAt: string; restaurantName: string; city: string | null; address: string | null; notes: string | null; vendorNote: string | null; lines: { id: string; productName: string; packLabel: string | null; packs: number; quantity: string; unit: string; lineTotalEur: string }[] };
function Orders() {
