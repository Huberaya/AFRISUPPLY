...
export default function Faq() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 lg:px-8">
      ...
      <p className="mt-10 text-sm text-stone-600">Une autre question ? <a className="underline" href="mailto:bonjour@afrisupply.fr">bonjour@afrisupply.fr</a> ou <Link to="/demander-un-acces" className="underline">demandez une démo</Link>.</p>
    </div>
  );
}
