...
export const PLANS: Plan[] = [
  ...
  { id: 'pro', name: 'Pro', priceMonthly: 89, tagline: 'L’intelligence qui fait gagner de la marge.', highlight: true, features: ['Tout Starter', 'Prévision des besoins 7 jours', 'Comparateur multi-fournisseurs', 'Panier intelligent & auto-reorder', 'Recettes, coût matière et marges', 'Assistant « Demander à l’IA »', 'Import CSV illimité', '1 établissement · 5 utilisateurs'] },
  { id: 'business', name: 'Business', priceMonthly: 199, tagline: 'Pour les groupes et les ambitieux.', highlight: false, features: ['Tout Pro', 'Achats groupés entre restaurants', 'Utilisateurs illimités', 'Accompagnement dédié'] },
];
...
export const FAQ: { q: string; a: string }[] = [
  ...
  { q: 'Combien de temps pour démarrer ?', a: '20 minutes : vous choisissez vos plats parmi nos recettes types (mafé, thiéb, attiéké poisson, ndolé…), l’app en déduit vos produits, vous saisissez ou importez vos fournisseurs, et vous faites un premier inventaire.' },
  ...
  { q: 'Et si j’ai plusieurs restaurants ?', a: 'AFRISUPPLY gère un établissement par compte pour l’instant. Les achats groupés entre restaurants sont réservés au plan Business ; dites-nous votre besoin multi-sites — c’est au programme.' },
